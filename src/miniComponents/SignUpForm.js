...
export default class signUpForm extends React.Component{
    constructor(){
        super();
        this.state = {errors: {}, email: "", pseudo: "", emailConfirmation: "", password: "", confirmationPassword: ""};
    ...
    handleSubmit(e){
        ...
        axios.post("http://localhost:4242/api/register", userData)
        .then((res) => {
        ...
        return(
            <div className="container">
                ...
                <form onSubmit={this.handleSubmit}>
                    <div className="tab">
                        <h1 className="accountSurfeurText">Inscription</h1>
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" className="form-control customized" onChange={this.onChange} name="pseudo" id="pseudo"/>
                            <p className="error">{this.state.errors.pseudo}</p>
                        </div>
                        <div className="form-group">
                        ...
                        <a className="anchorCustom" href="login">J'ai déjà un compte</a>
                    </div>
                </form>
                </div>
            </div>
